...
function App() {
   ...
   */
  return <>{displayResults ? <AddressResults displayResults={displayResults} formData={formData} setFormData={setFormData}/> : <AddressForm displayResults={displayResults} formData={formData} setFormData={setFormData}/>}</>;
}
